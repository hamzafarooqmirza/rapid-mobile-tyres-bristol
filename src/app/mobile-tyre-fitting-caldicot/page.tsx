...
export const metadata: Metadata = {
  title: "Mobile Tyre Fitting Caldicot | Rapid Mobile Tyres — 24/7 Service",
  description:
    "Need mobile tyre fitting in Caldicot? Rapid Mobile Tyres comes to your home, workplace or roadside — cars, vans and SUVs, 24/7. Usually within 45–60 minutes. Call now.",
...
const vehicleServices = [
  {
    ...
    description:
      "Our mobile car tyre fitting in Caldicot is available for many common hatchbacks, saloons, estates and family cars. Whether the tyre has failed unexpectedly or is simply due for replacement, fitting can be arranged at your location subject to the required size being available.",
  ...
  },
  {
    ...
    description:
      "For drivers who use vans for business or daily work, a tyre problem can quickly cause lost time. Our mobile van tyre fitting in Caldicot brings the replacement service to the vehicle, helping avoid an unnecessary journey to a tyre depot. Van tyres may have specific load requirements, so providing the full tyre specification when calling is useful.",
  ...
  },
  {
    ...
    description:
      "SUVs and 4x4s can use larger or more specialised tyre sizes than standard passenger cars. We provide SUV tyre fitting in Caldicot for suitable vehicles and specifications, subject to tyre availability.",
...
const steps = [
  ...
  },
  {
    ...
    description:
      "Because Caldicot includes both town streets and rural approach roads, an accurate postcode, road name or shared map location helps us reach you efficiently.",
  },
  {
...
const faqs = [
  {
    question: "Do you provide 24 hour mobile tyre fitting in Caldicot?",
    answer:
      "Yes. Our 24 hour mobile tyre fitting in Caldicot is available day and night, subject to technician availability and the required tyre being in stock.",
  },
  {
    question: "How quickly can a mobile tyre fitter reach Caldicot?",
    answer:
  ...
  {
    question: "Can you replace a tyre at my home in Caldicot?",
    answer:
      "Yes. Tyre replacement in Caldicot can be carried out at suitable residential locations where there is enough safe space for the technician to work.",
  },
  {
    question: "Do you provide emergency tyre fitting late at night?",
    answer:
      "Yes. Emergency tyre fitting in Caldicot is available 24/7, including evenings, nights and weekends, subject to availability.",
  },
  {
    question: "Can you help with a flat tyre near the B4245 or M48?",
    answer:
      "We provide roadside tyre assistance in Caldicot and along nearby roads where the vehicle is in a safe and accessible position. If you are stopped somewhere hazardous, follow appropriate roadside safety guidance first before requesting assistance.",
  },
  {
    question: "Do you provide mobile car tyre fitting in Caldicot?",
    answer:
  ...
  {
    question: "Can you replace van tyres in Caldicot?",
    answer:
      "Yes. Our mobile van tyre fitting in Caldicot covers suitable light commercial vehicles. Providing the current tyre size and load rating helps us identify an appropriate option.",
  },
  {
    question: "Do you fit tyres to SUVs and 4x4s in Caldicot?",
    answer:
  ...
  },
  {
    ...
    answer:
      "Yes. Mobile tyre replacement in Caldicot can be arranged for planned tyre changes as well as punctures and emergency callouts.",
  },
  {
    question: "Do you cover Caerwent and Portskewett from Caldicot?",
    answer:
      "Our wider service area includes nearby locations such as Caerwent and Portskewett. These locations also have dedicated service-area coverage on the Rapid Mobile Tyres website.",
  },
  {
    question: "What information should I give you if I am on a rural road near Caldicot?",
    answer:
      "Your exact location is particularly important. Provide the road name, postcode, a nearby landmark or a shared map location pin along with your tyre size and vehicle details.",
  },
];
      ...
      <main>
          ...
          <div className="relative mx-auto max-w-7xl px-4 py-24 sm:px-6 lg:px-8">
            <div className="max-w-2xl">
              ...
              <h1 className="mb-6 text-4xl font-extrabold tracking-tight sm:text-5xl lg:text-6xl">
                ...
                <span className="text-orange-400">Caldicot</span>
              </h1>
              <p className="mb-8 text-lg text-zinc-300 sm:text-xl">
                A flat or damaged tyre in Caldicot can disrupt your day quickly, especially if the
                nearest tyre centre is a drive away. Rapid Mobile Tyres provides mobile tyre
                fitting in Caldicot, bringing tyre replacement directly to your home, workplace or
            ...
            <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
              <div>
                ...
                <p className="mb-8 text-zinc-600">
                  ...
                  can risk making the problem worse. Our mobile tyre fitters in Caldicot arrive with
                  the equipment needed to replace tyres at suitable residential, workplace and
                  roadside locations — so the vehicle can stay where it is while the tyre service
                  comes to you.
                </p>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-zinc-600">
                        ...
                        around Caldicot and replace the tyre while the vehicle remains parked.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-zinc-900">Roadside Tyre Assistance in Caldicot</h3>
                      <p className="text-zinc-600">
                        Tyre damage on a road around Caldicot can leave you unable to continue
                        safely, especially if the tyre has completely deflated or suffered a
                        blowout. Our roadside tyre assistance can attend suitable locations where
                        the technician has safe and permitted access. If you are stopped in a
                        hazardous position, prioritise your safety first before calling.
                      </p>
                    </div>
                  </div>
                </div>
        ...
        <section className="bg-zinc-50 py-20">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mb-12 text-center">
              <h2 className="mb-4 text-3xl font-extrabold text-zinc-900">
                Emergency Mobile Tyre Fitting in Caldicot
              </h2>
              <p className="mx-auto max-w-2xl text-zinc-600">
                A puncture or blowout can happen outside normal garage hours, which is why Rapid
                Mobile Tyres provides emergency tyre fitting in Caldicot 24 hours a day. We can
            ...
            <div className="grid gap-8 sm:grid-cols-3">
              <div className="rounded-2xl bg-white p-8 shadow-sm ring-1 ring-zinc-100">
                ...
                <p className="text-zinc-600">
                  Day or night, our mobile tyre service is available 24 hours a day in Caldicot —
                  no waiting for garage opening times, even in the evenings or at weekends.
                </p>
              </div>
              <div className="rounded-2xl bg-white p-8 shadow-sm ring-1 ring-zinc-100">
                <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-orange-100 text-orange-600">
                ...
                <p className="text-zinc-600">
                  ...
                  availability and your exact location in Caldicot. No need to arrange recovery or
                  risk driving on a damaged tyre.
                </p>
              </div>
              <div className="rounded-2xl bg-white p-8 shadow-sm ring-1 ring-zinc-100">
                <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-orange-100 text-orange-600">
        ...
        <section className="bg-zinc-50 py-20">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mb-12 text-center">
              <h2 className="mb-4 text-3xl font-extrabold text-zinc-900">
                Arranging Your Caldicot Tyre Callout
              </h2>
              <p className="mx-auto max-w-2xl text-zinc-600">
          ...
          <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="max-w-2xl">
              <h2 className="mb-6 text-3xl font-extrabold">
                Mobile Tyre Assistance Near the B4245 and M48 Corridor
              </h2>
              <p className="mb-4 text-zinc-300">
                Caldicot sits close to the B4245 corridor, which connects the town with{" "}
                <Link href="/mobile-tyre-fitting-magor" className="text-orange-400 hover:underline">
                  Magor
                </Link>{" "}
                and{" "}
                <Link href="/mobile-tyre-fitting-caerwent" className="text-orange-400 hover:underline">
                  Caerwent
                </Link>{" "}
                to the west, and Newport towards the east. The M48 Severn Bridge corridor also
                provides a route between this part of South Wales and the Bristol area.
              </p>
              <p className="mb-4 text-zinc-300">
                Our mobile service can attend suitable locations in and around Caldicot, including
                roads connecting the town with nearby villages such as Portskewett and Llanvaches.
                If you experience tyre trouble on these routes, contact us with your exact location
                so we can confirm access and availability.
              </p>
              <p className="text-zinc-300">
                Providing your postcode, road name or shared location pin can help us identify
                you more easily, particularly on rural stretches between villages.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-white py-20">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="grid gap-12 lg:grid-cols-2 lg:items-start">
              <div>
                <h2 className="mb-4 text-3xl font-extrabold text-zinc-900">
                  Replacement Tyres for Caldicot Drivers
                </h2>
                <p className="mb-4 text-zinc-600">
                  Vehicles in Caldicot may be used for local journeys, commuting towards Newport or
                  travelling across into the Bristol area via the Severn crossing. The replacement
                  tyre therefore needs to meet the requirements of your vehicle, including the
                  correct dimensions, load index and speed rating.
                </p>
                <p className="mb-6 text-zinc-600">
                  Our mobile tyre replacement in Caldicot can include different tyre options
        ...
        {/* Why Mobile Tyre Fitting Suits Caldicot */}
        <section className="bg-zinc-50 py-20">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mb-12">
              <h2 className="mb-4 text-3xl font-extrabold text-zinc-900">
              ...
              <p className="max-w-2xl text-zinc-600">
                Being unable to drive in Caldicot can make reaching a tyre centre more difficult,
                particularly if public transport links are limited or a replacement vehicle is not
                readily available. Mobile fitting removes that problem by sending a technician
              ...
              {[
                {
                  ...
                  title: "24/7 Coverage",
                  body: "Rapid Mobile Tyres provides 24 hour mobile tyre fitting in Caldicot for suitable homes, workplaces and roadside locations.",
                },
                {
                  icon: (
                    <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z" />
        ...
        <section className="bg-white py-20">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mb-10">
              <h2 className="mb-4 text-3xl font-extrabold text-zinc-900">
                Covering Caldicot and Nearby Monmouthshire Areas
              </h2>
              <p className="max-w-2xl text-zinc-600">
                Caldicot sits close to{" "}
                <Link href="/mobile-tyre-fitting-caerwent" className="text-orange-500 hover:underline">
                  Caerwent
                </Link>
                ,{" "}
                <Link href="/mobile-tyre-fitting-magor" className="text-orange-500 hover:underline">
                  Magor
                </Link>{" "}
                and{" "}
                ...
                , while our wider service area also includes Newport and Portskewett. If you are
                outside Caldicot itself, provide your postcode or current location when calling so
              ...
              {[
                {
                  ...
                  body: "24/7 emergency mobile tyre fitting for unexpected punctures, blowouts and sidewall damage in and around Caldicot.",
                  icon: (
                    <path
                      fillRule="evenodd"
                ...
                },
                {
                  ...
                  body: "Arrange planned or emergency tyre replacement at your home address in Caldicot, on your driveway or at a safe residential location.",
                  icon: (
                    <path d="M10.707 2.293a1 1 0 00-1.414 0l-7 7a1 1 0 001.414 1.414L4 10.414V17a1 1 0 001 1h2a1 1 0 001-1v-2a1 1 0 011-1h2a1 1 0 011 1v2a1 1 0 001 1h2a1 1 0 001-1v-6.586l.293.293a1 1 0 001.414-1.414l-7-7z" />
                  ),
                },
                ...
                },
                {
                  ...
                  body: "If a flat battery rather than a tyre is the problem, our mobile jump start service can attend suitable locations in and around Caldicot.",
                  icon: (
                    <path
                      fillRule="evenodd"
                ...
                },
                {
                  ...
                  body: "Run out of fuel near Caldicot? Our emergency fuel delivery service can bring the right fuel to your location.",
                  icon: (
                    <path
                      fillRule="evenodd"
        ...
        <section className="relative bg-zinc-900 py-20 text-white overflow-hidden">
          ...
          <div className="relative mx-auto max-w-7xl px-4 text-center sm:px-6 lg:px-8">
            <h2 className="mb-4 text-3xl font-extrabold sm:text-4xl">
              Need Mobile Tyre Fitting in Caldicot?
            </h2>
            <p className="mx-auto mb-8 max-w-2xl text-zinc-300">
              A damaged or flat tyre does not have to mean trying to drive to a garage from
              Caldicot. Rapid Mobile Tyres can bring mobile tyre fitting directly to your home,
              workplace or suitable roadside location. Contact us with your location, tyre size and
              vehicle details, and we can check availability and arrange a mobile technician for
              your callout.
            </p>
