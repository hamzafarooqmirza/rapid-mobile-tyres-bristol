...
export const metadata: Metadata = {
  title: "Mobile Tyre Fitting Bitton | Rapid Mobile Tyres — 24/7 Service",
  description:
    "Need mobile tyre fitting in Bitton? Rapid Mobile Tyres comes to your home, workplace or roadside — cars, vans and SUVs, 24/7. Usually within 45–60 minutes. Call now.",
};
