...
const vehicleServices = [
  {
    ...
    description:
      "Fitting for hatchbacks, saloons, estates and family cars at a suitable home, workplace or roadside location in Bridgwater.",
...
const steps = [
  ...
  },
  {
    ...
    description:
      "Tell us whether the vehicle is at home, at work or stopped on the roadside. A postcode, road name or shared location is particularly useful.",
  },
  {
...
const faqs = [
  {
    question: "Do you provide 24 hour mobile tyre fitting in Bridgwater?",
    answer:
      "Yes. Our 24 hour mobile tyre fitting in Bridgwater is available day and night, subject to technician availability and the required tyre being available.",
  },
  {
    question: "How quickly can a mobile tyre fitter reach Bridgwater?",
    answer:
  ...
  {
    question: "Can you replace a tyre at my home in Bridgwater?",
    answer:
      "Yes. Tyre replacement in Bridgwater can be carried out at suitable residential locations where there is enough safe working space around the vehicle.",
  },
  {
    question: "Can you help if I have a flat tyre near the M5?",
    answer:
      "We provide roadside tyre assistance around Bridgwater and nearby routes where safe access is available. Junction 23 of the M5 connects with the Dunball area north of Bridgwater. If you are stopped on the motorway, follow motorway safety guidance first.",
  },
  {
    question: "Do you provide roadside tyre assistance near the A38?",
    answer:
      "Yes. Our roadside tyre assistance in Bridgwater can attend suitable locations around the A38 and surrounding roads, provided it is safe and permitted to work there.",
  },
  {
    question: "Is emergency tyre fitting available late at night?",
    answer:
      "Yes. Emergency tyre fitting in Bridgwater is available 24/7, including nights and weekends, subject to technician and tyre availability.",
  },
  {
    question: "Do you offer mobile car tyre fitting in Bridgwater?",
    answer:
  ...
  },
  {
    ...
    answer:
      "Yes. Our mobile van tyre fitting in Bridgwater covers suitable light commercial vehicles. Because van tyres can require specific load ratings, provide the full tyre specification where possible.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Yes. Mobile tyre replacement in Bridgwater can be arranged for planned tyre changes as well as punctures and emergency callouts.",
  },
  {
  ...
  {
    question: "Do you cover locations outside Bridgwater?",
    answer:
      "Yes. Our wider mobile tyre service covers Bridgwater and surrounding parts of Somerset, subject to technician availability. Call with your postcode to confirm coverage for your exact location.",
  },
];

const areasServed = [
  { name: "Bridgwater", href: null },
  { name: "Dunball", href: null },
  { name: "Puriton", href: null },
  { name: "North Petherton", href: null },
  { name: "Cannington", href: null },
  { name: "Wembdon", href: null },
  { name: "Chilton Trinity", href: null },
  { name: "Taunton", href: null },
  { name: "Weston-super-Mare", href: "/mobile-tyre-fitting-weston-super-mare" },
];
...
export default function BridgwaterPage() {
  return (
    <>
      <Header />
      <main>
          ...
          <div className="relative mx-auto max-w-7xl px-4 py-24 sm:px-6 lg:px-8">
            <div className="max-w-2xl">
              ...
              <h1 className="mb-6 text-4xl font-extrabold tracking-tight sm:text-5xl lg:text-6xl">
                ...
                <span className="text-orange-400">Bridgwater</span>
              </h1>
              <p className="mb-8 text-lg text-zinc-300 sm:text-xl">
                ...
                town, heading towards the motorway or preparing to leave home. Our mobile tyre
                fitters come to your vehicle in Bridgwater — usually within 45–60 minutes, 24/7 for
                cars, vans and SUVs.
              </p>
            ...
            <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
              <div>
                ...
                <p className="mb-8 text-zinc-600">
                  ...
                  practical. Our mobile tyre fitters in Bridgwater bring the fitting service to your
                  location, allowing the vehicle to remain where it is while the replacement is
                  carried out.
                </p>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-zinc-600">
                        If you notice a puncture, damaged sidewall or worn tyre while your vehicle
                        is parked at home, mobile fitting can save you from an unnecessary garage
                        journey. Where there is enough safe working space, we can carry out tyre
                        replacement on a driveway or suitable residential parking area — including
                        planned changes before a tyre becomes an emergency. Our{" "}
                        <Link href="/tyre-replacement-at-home-bristol" className="text-orange-500 hover:underline">
                          home tyre replacement service
                        </Link>{" "}
                        is available for both emergency and planned callouts.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-zinc-900">Workplace Mobile Tyre Fitting</h3>
                      <p className="text-zinc-600">
                        A tyre problem during the working day can be especially disruptive when your
                        vehicle is needed for commuting or business. Our mobile tyre service can
                        attend suitable workplaces around Bridgwater and carry out the replacement
                        while the vehicle remains parked — useful for tradespeople, commuters and
                        drivers who rely on their vehicle throughout the day.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-zinc-900">Roadside Tyre Assistance in Bridgwater</h3>
                      <p className="text-zinc-600">
                        A puncture or blowout while travelling can make it unsafe to continue
                        driving. Our roadside tyre assistance in Bridgwater is available at suitable
                        locations where there is enough safe and permitted access for the technician
                        to work. If your vehicle is stopped somewhere hazardous or on a high-speed
                        road, follow the relevant roadside safety guidance before arranging
                        assistance.
                      </p>
                    </div>
                  </div>
              ...
              <div className="relative">
                <div className="overflow-hidden rounded-2xl">
                  <Image
                    src="/mobile-tyre-fitting-technician-bristol.webp"
                    alt="Mobile tyre fitting technician fitting a tyre at a customer's location in Bridgwater"
                    width={600}
                    height={450}
        ...
        <section className="bg-zinc-50 py-20">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mb-12 text-center">
              <h2 className="mb-4 text-3xl font-extrabold text-zinc-900">
                Emergency Mobile Tyre Fitting in Bridgwater
              </h2>
              <p className="mx-auto max-w-2xl text-zinc-600">
                Tyre damage can happen at any hour, not just when tyre centres are open. Rapid
                Mobile Tyres provides emergency tyre fitting in Bridgwater 24 hours a day for
                punctures, blowouts, complete pressure loss and sidewall damage.
              </p>
            </div>
            <div className="grid gap-8 sm:grid-cols-3">
              <div className="rounded-2xl bg-white p-8 shadow-sm ring-1 ring-zinc-100">
                ...
                <p className="text-zinc-600">
                  ...
                  garage opening times across Bridgwater and the surrounding Somerset area.
                </p>
              </div>
              <div className="rounded-2xl bg-white p-8 shadow-sm ring-1 ring-zinc-100">
                <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-orange-100 text-orange-600">
        ...
        <section className="bg-white py-20">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mb-12 text-center">
              ...
              <p className="mx-auto max-w-2xl text-zinc-600">
                Different vehicles require different tyre sizes and specifications. Providing the
                tyre size when you call helps us check suitable availability before the technician
                sets off.
              </p>
            </div>
            <div className="grid gap-8 sm:grid-cols-3">
          ...
          <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="max-w-2xl">
              ...
              <p className="mb-4 text-zinc-300">
                Bridgwater sits on an important Somerset road network. The A38 and A39 meet in the
              ...
              <p className="mb-4 text-zinc-300">
                Our mobile tyre service can attend suitable locations around Bridgwater and the
                surrounding road network where access is safe and permitted. Nearby areas including{" "}
                <Link href="/mobile-tyre-fitting-weston-super-mare" className="text-orange-400 hover:underline">
                  Weston-super-Mare
                </Link>{" "}
                and the wider Somerset coast are also within our service reach.
              </p>
              <p className="text-zinc-300">
                If you are stopped near the motorway or another busy route, provide your direction
                of travel, nearest junction or accurate shared location when requesting assistance.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="grid gap-12 lg:grid-cols-2 lg:items-start">
              <div>
                ...
                <p className="mb-4 text-zinc-600">
                  Vehicles around Bridgwater may be used for local journeys, daily commuting,
                  motorway travel and longer trips across Somerset. The replacement tyre therefore
                  needs to match the vehicle specification and intended use rather than simply fit
                  the wheel.
                </p>
                <p className="mb-6 text-zinc-600">
                  Our mobile tyre replacement in Bridgwater can include different tyre options
                  according to the required size, load rating, speed rating and current availability.
                  Providing the complete tyre details when booking helps us identify a suitable
        ...
        <section className="bg-zinc-50 py-20">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mb-12">
              <h2 className="mb-4 text-3xl font-extrabold text-zinc-900">
                Why Mobile Tyre Fitting Makes Sense in Bridgwater
              </h2>
              ...
              {[
                {
                  ...
                  title: "24/7 Coverage",
                  body: "Rapid Mobile Tyres provides 24 hour mobile tyre fitting in Bridgwater, covering suitable homes, workplaces and roadside locations.",
                },
                {
                  icon: (
                    <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z" />
                  ...
                  body: "Mobile fitting removes the need to drive on a flat or damaged tyre to reach a depot — the technician and tyre come to you.",
                },
                {
                  icon: (
                    <path
                  ...
                  body: "The service works for unexpected tyre failures as well as planned replacement when tyres are worn but the vehicle is still safely parked.",
                },
                {
                  icon: (
                    <>
        ...
        <section className="bg-white py-20">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mb-10">
              <h2 className="mb-4 text-3xl font-extrabold text-zinc-900">
                Covering Bridgwater and Nearby Somerset Areas
              </h2>
              <p className="max-w-2xl text-zinc-600">
                Bridgwater is closely connected with surrounding communities including Dunball,
                Puriton and the wider Sedgemoor area, with Junction 23 of the M5 providing an
                important connection north and south. Our mobile tyre service can also assist
                drivers in surrounding locations — including{" "}
                <Link href="/mobile-tyre-fitting-weston-super-mare" className="text-orange-500 hover:underline">
                  Weston-super-Mare
                </Link>{" "}
            ...
            <p className="mt-6 text-sm text-zinc-500">
              If you are outside Bridgwater itself, provide your postcode or current location when
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mb-12 text-center">
              ...
              <p className="mx-auto max-w-2xl text-zinc-600">
                ...
                for drivers in Bridgwater and surrounding areas.
              </p>
            </div>
              ...
              {[
                {
                  ...
                  body: "24/7 emergency mobile tyre fitting for unexpected punctures, blowouts and sidewall damage across Bridgwater and the surrounding Somerset area.",
                  icon: (
                    <path
                      fillRule="evenodd"
                ...
                },
                {
                  ...
                  body: "If a flat battery rather than a tyre is the problem, our mobile jump start service can attend suitable locations in and around Bridgwater.",
                  icon: (
                    <path
                      fillRule="evenodd"
                ...
                },
                {
                  ...
                  body: "Run out of fuel near Bridgwater? Our emergency fuel delivery service can bring the right fuel to your location.",
                  icon: (
                    <path
                      fillRule="evenodd"
        ...
        <section className="relative bg-zinc-900 py-20 text-white overflow-hidden">
          ...
          <div className="relative mx-auto max-w-7xl px-4 text-center sm:px-6 lg:px-8">
            <h2 className="mb-4 text-3xl font-extrabold sm:text-4xl">
              Need Mobile Tyre Fitting in Bridgwater?
            </h2>
            <p className="mx-auto mb-8 max-w-2xl text-zinc-300">
              A puncture, blowout or badly worn tyre does not have to mean attempting to drive an
              unsafe vehicle to a tyre centre. Contact us with your location, vehicle details and
              tyre size, and we can check the appropriate tyre and technician availability for your
              callout.
            </p>
